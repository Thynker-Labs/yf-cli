---
name: yf-cli
description: Fetch stock quotes and historical data from Yahoo Finance via the yf CLI. Use when the user asks for stock prices, quotes, market data, historical data, or CSV output for multiple tickers.
compatibility: Requires Node.js; network access for Yahoo Finance API.
---
